...
import me.thejokerdev.hungercraftgames.menus.CreateChests;
...
public class SetupCMD extends CMD {
    ...
    public String permission() {
        return "hgc.admin.setup";
    }

    @Override
    public boolean onCMD(CommandSender sender, String alias, String[] args) {
        Player p = (Player)sender;
        Menu menu = MenuListener.getPlayerMenu(p, "CreateChests");
        if (menu == null){
            menu = new CreateChests(plugin, p);
        }
