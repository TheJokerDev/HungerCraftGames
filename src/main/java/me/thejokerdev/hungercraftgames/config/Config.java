package me.thejokerdev.hungercraftgames.config;
...
public class Config {
    ...
    public Config(Main plugin, File file) {
        this.file = file;
        this.load();
        this.plugin = plugin;
    }

    public Config(Main plugin, String fileName, boolean save) {
    ...
    public Config(Main plugin, File folder, String fileName, boolean save) {
        File file = new File(folder(folder), fileName);
        if (!file.exists() && save){
            plugin.saveResource(folder.getPath()+"/"+fileName, false);
        }
        this.plugin = plugin;
        this.file = file;
        load();
    ...
    public String getString(String path) {
        return this.config.getString(plugin.getUtils().ct(path));
    }
