...
public class ItemBuilder {
   ...
   public ItemBuilder setName(String name){
     ...
     im.setDisplayName(Utils.translateCCode('&', name));
     is.setItemMeta(im);
     return this;
   }
   /**
   ...
   public ItemBuilder setLore(String... lore){
     setLore(Arrays.stream(lore).map(m->Utils.translateCCode('&', m)).collect(Collectors.toList()));
     return this;
   }
   /**
    * Re-sets the lore.
   ...
   public ItemBuilder setLore(List<String> lore) {
     ItemMeta im = is.getItemMeta();
     im.setLore(lore.stream().map(m->Utils.translateCCode('&', m)).collect(Collectors.toList()));
     is.setItemMeta(im);
     return this;
   }
   ...
   public ItemBuilder addLoreLine(String line){
     ...
     lore.add(Utils.translateCCode('&', line));
     im.setLore(lore);
     is.setItemMeta(im);
     return this;
   }
   ...
   public ItemBuilder addLoreLine(String line, int pos){
     ItemMeta im = is.getItemMeta();
     List<String> lore = new ArrayList<>(im.getLore());
     lore.set(pos, Utils.translateCCode('&', line));
     im.setLore(lore);
     is.setItemMeta(im);
     return this;
   }
